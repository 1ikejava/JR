...
public class Solution
{
    public static void main(String[] args) throws IOException
    {
        ...
        String fahterName = reader.readLine();
        Cat catFather = new Cat(fahterName, catGrandpa, null);
    ...
    public static class Cat
    {
        ...
        public String toString()
        {
            return "Cat name is " + name +","+
                    ((parentMom!=null ? " mother is " + parentMom.name : " no mother") +
                     (parentDad!=null ? ", father is " + parentDad.name : ", no father"));
